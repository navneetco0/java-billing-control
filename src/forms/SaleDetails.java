...
public class SaleDetails extends JInternalFrame implements MouseListener, ActionListener, ItemListener, KeyListener {
    ...
    private Container c;
    private SaleDetailsDtlBackground obj1;
    private SaleDetailsDtlHeading obj2;

    private class SaleDetailsDtlBackground extends JPanel {
        private SaleDetailsDtlBackground() {
            setLayout(null);
    ...
    private class SaleDetailsDtlHeading extends JPanel {
        private SaleDetailsDtlHeading() {
            setLayout(null);
    ...
    public SaleDetails() {
        ...
        c = getContentPane();
        c.setLayout(null);
        obj1 = new SaleDetailsDtlBackground();
        obj2 = new SaleDetailsDtlHeading();
