...
public class StockDetails extends JInternalFrame implements MouseListener, ActionListener {
    ...
    private Container c;
    private StockDetailsDtlBackground obj1;
    private StockDetailsDtlHeading obj2;

    private class StockDetailsDtlBackground extends JPanel {
        private StockDetailsDtlBackground() {
            setLayout(null);
    ...
    private class StockDetailsDtlHeading extends JPanel {
        private StockDetailsDtlHeading() {
            setLayout(null);
    ...
    public StockDetails() {
        ...
        c = getContentPane();
        c.setLayout(null);
        obj1 = new StockDetailsDtlBackground();
        obj2 = new StockDetailsDtlHeading();
