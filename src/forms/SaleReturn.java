...
public class SaleReturn extends JInternalFrame implements MouseListener, ActionListener, ItemListener, KeyListener {
    ...
    private Container c;
    private SaleReturnDtlBackground obj1;
    private SaleReturnDtlHeading obj2;

    private class SaleReturnDtlBackground extends JPanel {
        private SaleReturnDtlBackground() {
            setLayout(null);
    ...
    private class SaleReturnDtlHeading extends JPanel {
        private SaleReturnDtlHeading() {
            setLayout(null);
    ...
    public SaleReturn() {
        ...
        c = getContentPane();
        c.setLayout(null);
        obj1 = new SaleReturnDtlBackground();
        obj2 = new SaleReturnDtlHeading();
